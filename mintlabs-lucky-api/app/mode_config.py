"""Static mode configuration for themed generator modes.

This file provides a canonical mapping from mode types -> option keys. Each
option includes a stable seed string (used by RNG to derive deterministic
but non-predictive shuffles), a human label and optionally an emoji token.
...
MODE_CONFIG: dict[str, dict[str, list[dict[str, str]]]] = {
    "zodiac": {
        ...
        "items": [
            ...
            },
            {
                ...
                "label": "Capricorn",
                "emoji": "♑",
                "seed": "zodiac:capricorn",
            },
            {
                "key": "aquarius",
                "label": "Aquarius",
                "emoji": "♒",
                "seed": "zodiac:aquarius",
            },
            {
                "key": "pisces",
                "label": "Pisces",
    ...
    "favorite_color": {
        "label": "Color",
        "items": [
            {"key": "blue", "label": "Blue", "emoji": "🔵", "seed": "color:blue"},
            {"key": "green", "label": "Green", "emoji": "🟢", "seed": "color:green"},
            {"key": "red", "label": "Red", "emoji": "🔴", "seed": "color:red"},
            {"key": "purple", "label": "Purple", "emoji": "🟣", "seed": "color:purple"},
            {"key": "black", "label": "Black", "emoji": "⚫", "seed": "color:black"},
            {"key": "yellow", "label": "Yellow", "emoji": "🟡", "seed": "color:yellow"},
        ],
    },
    "gemstone": {
        "label": "Gemstone",
        ...
        "items": [
            {
                ...
                "label": "Ashwini",
                "emoji": "🌟",
                "seed": "jyotish:ashwini",
            },
            {
                "key": "bharani",
                "label": "Bharani",
                "emoji": "🌙",
                "seed": "jyotish:bharani",
            },
            {
                "key": "krittika",
                "label": "Krittika",
                "emoji": "🔥",
                "seed": "jyotish:krittika",
            },
            {
                "key": "rohini",
                "label": "Rohini",
...
# star_sign is an alias for zodiac for backward compatibility
MODE_CONFIG["star_sign"] = MODE_CONFIG["zodiac"]
