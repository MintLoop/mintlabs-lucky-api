...
| ----- | ----- | ------ | ------ | ----- |
| Bugfix – Mobile header overflow | Codex (GPT-5) | `feature/frontend-header-overflow` | 📝 PR open | Restore frontend rate-limit toast/throttle (client + 429 handling), add dev-only request logging, harden header overflow and keep "Lucky Number Today" title. PR: https://github.com/MintLoop/mintlabs-lucky-api/pull/25 |
