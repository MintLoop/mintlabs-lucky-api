...
| ----- | ----- | ------ | ------ | ----- |
| Bugfix – Mobile header overflow | Codex (GPT-5) | `feature/frontend-rate-limit-guardrails` | 📝 PR open | Adjust client limiter to allow a small burst but still toast + block when smashed repeatedly. PR: https://github.com/MintLoop/mintlabs-lucky-api/pull/28 |
