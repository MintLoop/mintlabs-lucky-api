...
| ----- | ----- | ------ | ------ | ----- |
| 1 – Automation Gatekeeper | Codex (GPT-5) | phase-1-automation | In review | CI workflow + docs ready on phase-1-automation HEAD; awaiting PR packaging. |
| 2 – Reliability Ops | _TBD_ | _TBD_ | Blocked (wait for Phase 1) | Needs CI artifacts in place. |
