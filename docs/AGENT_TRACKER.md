...
| ----- | ----- | ------ | ------ | ----- |
| Bugfix – Mobile header overflow | Codex (GPT-5) | `feature/frontend-header-overflow` | 📝 PR open | Fix iOS header title overflow by allowing flex child shrink/wrap; add safe-area-aware padding for demo header. PR: https://github.com/MintLoop/mintlabs-lucky-api/pull/25 |
