...
| ----- | ----- | ------ | ------ | ----- |
| Bugfix – Mobile header overflow | Codex (GPT-5) | `feature/frontend-header-overflow` | 🔄 In Progress | Fix iOS header title overflow by allowing flex child shrink/wrap; add safe-area-aware padding for demo header. |
