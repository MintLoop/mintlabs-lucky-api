...
| ----- | ----- | ------ | ------ | ----- |
| Bugfix – Mobile header overflow | Codex (GPT-5) | `feature/frontend-rate-limit-guardrails` | 🔄 In Progress | Adjust client limiter to allow a small burst but still toast + block when smashed repeatedly. |
